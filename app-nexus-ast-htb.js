...
var PartnerSpecificValidator = require('app-nexus-ast-htb-validator.js');
 ...
 * @class
 */
function AppNexusAstHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'AppNexusAstHtb', // PartnerName
            namespace: 'AppNexusAstHtb', // Should be same as partnerName
            statsId: 'APNXA', // Unique partner identifier
            version: '2.1.1',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
